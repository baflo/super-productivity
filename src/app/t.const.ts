const T = {
  ...
  F: {
    ...
    WORKFLOW: {
      S: {
        ADDED: 'F.WORKFLOW.S.ADDED',
        UPDATED: 'F.WORKFLOW.S.UPDATED',
        DELETED: 'F.WORKFLOW.S.DELETED',
      },
      LABEL: {
        TITLE: 'F.WORKFLOW.LABEL.TITLE',
        TRIGGER: 'F.WORKFLOW.LABEL.TRIGGER',
        CONDITION: 'F.WORKFLOW.LABEL.CONDITION',
        ACTIONS: 'F.WORKFLOW.LABEL.ACTIONS',
        ENABLED: 'F.WORKFLOW.LABEL.ENABLED',
        ADD_WORKFLOW: 'F.WORKFLOW.LABEL.ADD_WORKFLOW',
        EDIT_WORKFLOW: 'F.WORKFLOW.LABEL.EDIT_WORKFLOW',
        DELETE_WORKFLOW: 'F.WORKFLOW.LABEL.DELETE_WORKFLOW',
        RUN_WORKFLOW: 'F.WORKFLOW.LABEL.RUN_WORKFLOW',
        NO_WORKFLOWS: 'F.WORKFLOW.LABEL.NO_WORKFLOWS',
        CONDITION_JSON: 'F.WORKFLOW.LABEL.CONDITION_JSON',
        ADD_CONDITION: 'F.WORKFLOW.LABEL.ADD_CONDITION',
        ADD_ACTION: 'F.WORKFLOW.LABEL.ADD_ACTION',
      },
      TRIGGER: {
        TASK_CREATED: 'F.WORKFLOW.TRIGGER.TASK_CREATED',
        TASK_CREATED_FROM_PROVIDER: 'F.WORKFLOW.TRIGGER.TASK_CREATED_FROM_PROVIDER',
        TAG_ADDED: 'F.WORKFLOW.TRIGGER.TAG_ADDED',
        TAG_REMOVED: 'F.WORKFLOW.TRIGGER.TAG_REMOVED',
        TASK_COMPLETED: 'F.WORKFLOW.TRIGGER.TASK_COMPLETED',
        TASK_SCHEDULED: 'F.WORKFLOW.TRIGGER.TASK_SCHEDULED',
        TASK_MOVED_TO_PROJECT: 'F.WORKFLOW.TRIGGER.TASK_MOVED_TO_PROJECT',
        MANUAL: 'F.WORKFLOW.TRIGGER.MANUAL',
      },
      CONDITION: {
        HAS_TAG: 'F.WORKFLOW.CONDITION.HAS_TAG',
        IN_PROJECT: 'F.WORKFLOW.CONDITION.IN_PROJECT',
        FROM_PROVIDER: 'F.WORKFLOW.CONDITION.FROM_PROVIDER',
        TITLE_MATCHES: 'F.WORKFLOW.CONDITION.TITLE_MATCHES',
        NOT: 'F.WORKFLOW.CONDITION.NOT',
        AND: 'F.WORKFLOW.CONDITION.AND',
        OR: 'F.WORKFLOW.CONDITION.OR',
      },
      ACTION: {
        ADD_TAG: 'F.WORKFLOW.ACTION.ADD_TAG',
        REMOVE_TAG: 'F.WORKFLOW.ACTION.REMOVE_TAG',
        SCHEDULE_TODAY: 'F.WORKFLOW.ACTION.SCHEDULE_TODAY',
        SCHEDULE_TOMORROW: 'F.WORKFLOW.ACTION.SCHEDULE_TOMORROW',
        SCHEDULE_DAY_OFFSET: 'F.WORKFLOW.ACTION.SCHEDULE_DAY_OFFSET',
        UNSCHEDULE: 'F.WORKFLOW.ACTION.UNSCHEDULE',
        MOVE_TO_PROJECT: 'F.WORKFLOW.ACTION.MOVE_TO_PROJECT',
        SET_ESTIMATE: 'F.WORKFLOW.ACTION.SET_ESTIMATE',
        ADD_SUBTASK: 'F.WORKFLOW.ACTION.ADD_SUBTASK',
        MARK_DONE: 'F.WORKFLOW.ACTION.MARK_DONE',
        SHOW_NOTIFICATION: 'F.WORKFLOW.ACTION.SHOW_NOTIFICATION',
      },
    },
    TASK_VIEW: {
      CUSTOMIZER: {
